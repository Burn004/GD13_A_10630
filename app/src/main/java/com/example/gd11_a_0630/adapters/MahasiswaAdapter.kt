package com.example.gd11_a_0630.adapters
...
import com.example.gd11_a_0630.AddEditActivity
import com.example.gd11_a_0630.MainActivity
import com.example.gd11_a_0630.R
import com.example.gd11_a_0630.models.Mahasiswa
import java.util.*
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
            ...
            materialAlertDialogBuilder.setTitle("Konfirmasi")
                ...
                .setPositiveButton("Hapus") { _, _ ->
                    if(context is MainActivity) mahasiswa.id?.let { it1 ->
                        (context as MainActivity).deleteMahasiswa(
                            it1
                        )
                    }
                }
        ...
        holder.cvMahasiswa.setOnClickListener {
            ...
            if (context is MainActivity)
                (context as MainActivity).startActivityForResult(i, MainActivity.LAUNCH_ADD_ACTIVITY)
        }
    }
    ...
    override fun getFilter(): Filter {
        return object : Filter(){
            ...
            override fun publishResults(p0: CharSequence?, p1: FilterResults?) {
                ...
                filteredMahasiswaList.addAll((p1?.values as List<Mahasiswa>))
