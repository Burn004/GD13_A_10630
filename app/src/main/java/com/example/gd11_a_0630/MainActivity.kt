...
import com.example.gd11_a_0630.adapters.MahasiswaAdapter
    ...
    private fun allMahasiswa(){
        ...
        StringRequest(Method.GET, MahasiswaApi.GET_ALL_URL, Response.Listener { response ->
            ...
            if(!mahasiswa.isEmpty())
                Toast.makeText(this@MainActivity, "Data barhasil Diambil!", Toast.LENGTH_SHORT).show()
            else
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.DELETE, MahasiswaApi.DELETE_URL + id, Response.Listener { response ->
                ...
                try {
                    ...
                    Toast.makeText(this@MainActivity, error.getString("message"),
                    Toast.LENGTH_SHORT
                    ).show()
