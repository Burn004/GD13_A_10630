package com.example.gd11_a_0630
...
import com.example.gd11_a_0630.api.MahasiswaApi
...
class AddEditActivity : AppCompatActivity() {
    ...
    private var layoutLaoding: LinearLayout? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        layoutLaoding = findViewById(R.id.layout_loading)
    ...
    private fun getMahasiswaById(id: Long) {
        ...
        val stringRequest: StringRequest = object :
            StringRequest(Method.GET, MahasiswaApi.GET_BY_ID_URL + id, { response ->
                val gson = Gson()
    ...
    private fun setLoading(isLoading: Boolean) {
        if (isLoading) {
            ...
            layoutLaoding!!.visibility = View.VISIBLE
        } else {
            window.clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE)
            layoutLaoding!!.visibility = View.INVISIBLE
        }
    }
}
